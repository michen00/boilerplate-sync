...
describe('generatePrBody', () => {
  it('generates body with updated files', () => {
    ...
    expect(body).toContain('### ✅ Updated (1 file)');
  ...
  it('generates body with created files', () => {
    ...
    expect(body).toContain('### 🆕 Created (1 file)');
  ...
  it('generates body with skipped files', () => {
    ...
    expect(body).toContain('### ⏭️ Skipped (1 file)');
  ...
  it('generates body with failed files', () => {
    ...
    expect(body).toContain('### ❌ Failed (1 file)');
  ...
  it('includes all-failed warning', () => {
    ...
    expect(body).toContain('⚠️ **All files failed to sync.**');
  ...
  it('generates body with mixed results', () => {
    ...
    expect(body).toContain('### ⏭️ Skipped');
...
describe('generateStepSummary', () => {
  ...
  it('shows PR will be created when changes detected', () => {
    ...
    expect(stepSummary).toContain('✅ Changes detected - PR will be created');
  });
  ...
  it('shows draft PR message when all failed', () => {
    ...
    expect(stepSummary).toContain('⚠️ All files failed - draft PR will be created');
  });
  ...
  it('shows no PR needed when no changes', () => {
    ...
    expect(stepSummary).toContain('ℹ️ No changes detected - no PR needed');
  });
});
